...
namespace BookRentalSystem.Presentation
{
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            userRepository.Add(new User(1, "Shahzeb"));
            userRepository.Add(new User(2, "Umar"));
            userRepository.Add(new User(3, "Khurram"));

            bookRepository.Add(new Book(1, "Harry Potter"));
            bookRepository.Add(new Book(2, "The Figthers"));
            bookRepository.Add(new Book(3, "C# Fundamentals"));
